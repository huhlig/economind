...
use crate::{
    DailyDataProvider, IntradayDataProvider, ProviderError, ProviderResult, RateLimitedClient,
};
use async_trait::async_trait;
use chrono::{DateTime, NaiveDate, NaiveDateTime, Utc};
use economind_datamodel::model::{
    CandleEntry, CandleSeries, DailyCandleEntry, DailyCandleSeries, Interval, Symbol,
};
use governor::Quota;
